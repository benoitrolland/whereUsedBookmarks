...
browser.contextMenus.create({
    id: "where-used-bookmark",
    title: "Where Used",
    contexts: ["link","bookmark"],
},function(){console.log("context create initialized.")});

//console.log("context type",browser.contextMenus.);
browser.contextMenus.onClicked.addListener((info, tab) => {
    
    if (info.menuItemId === "where-used-bookmark") {
